...
<head>
    ...
    <title>Monitoring Kamar Tidur</title>
...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Monitoring Kamar Tidur</h1>
    ...
    <script>
        $(document).ready(function() {
            ...
            function updateCardData(temperature, humidity) {
            ...
            function fetchSensorData() {
                $.get('{{ route('getRestroomData') }}', function(response) {
                    if (!response.suhu || !response.kelembapan) {
                    ...
                    createChart(response.suhu, 'temperatureChart', 'Suhu (°C)', 'rgba(255, 99, 132, 0.2)',
                        'rgba(255, 99, 132, 1)');
            ...
            setInterval(fetchSensorData, 30000); // 30 seconds
        });
    </script>
</body>
