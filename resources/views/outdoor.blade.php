        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Monitoring Outdoor</h1>
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-warning">Grafik Sensor Intensitas Cahaya</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <div class="chart-area">
    ...
    <script>
        $(document).ready(function() {
            ...
            function fetchSensorData() {
                $.ajax({
                    url: "{{ route('getOutdoorData') }}",
                    method: "GET",
                    dataType: "json",
                    success: function(data) {
                        // Update cards with the latest data
                        $('#temperature').text(parseFloat(data.suhu.data[0]).toFixed(1) + ' °C');
                        $('#humidity').text(parseFloat(data.kelembapan.data[0]).toFixed(1) + ' %');
                        $('#lux').text(parseFloat(data.cahaya.data[0]).toFixed(0) + ' lx');

                        // Update charts
                        createChart(data.suhu, 'temperatureChart', 'Suhu (°C)',
                            'rgba(255, 99, 132, 0.2)', 'rgba(255, 99, 132, 1)');
                        createChart(data.kelembapan, 'humidityChart', 'Kelembapan (%)',
                            'rgba(54, 162, 235, 0.2)', 'rgba(54, 162, 235, 1)');
                        createChart(data.cahaya, 'luxChart', 'Cahaya (lx)', 'rgba(255, 206, 86, 0.2)',
                            'rgba(255, 206, 86, 1)');
                    },
                    error: function() {
